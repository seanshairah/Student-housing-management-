export const APP_NAME = "Student Housing";
export const APP_TAGLINE = "Modern student accommodation, beautifully managed.";

export const HOUSES = {
  MUFUDZI: { name: "Mufudzi House", slug: "mufudzi" },
  SIPHIWE: { name: "Siphiwe House", slug: "siphiwe" },
} as const;
