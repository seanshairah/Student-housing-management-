  ...
  return (
    <Link
      ...
      className={cn(
        ...
        "fixed bottom-5 right-4 z-40 inline-flex items-center justify-center gap-2 rounded-full bg-primary px-5 py-3.5 text-sm font-semibold text-primary-foreground shadow-lg shadow-brand-900/20 transition-all duration-300 lg:hidden",
        visible
